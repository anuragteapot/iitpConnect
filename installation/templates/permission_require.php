...
<div class="container">
  <div class="container-main">
    <div class="alert-main">
      <h1 id="headerText">Insufficient Permission for Folder Access To run application</h1>
      <p><span id="descText1">Your host needs to change the Permission to Minimum 644.</span></p>
    </div>
  </div>
</div>
</body>
