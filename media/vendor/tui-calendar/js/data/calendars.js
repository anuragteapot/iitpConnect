...
(function() {
    ...
    var id = 0;
        ...
        calendar.name = 'To Patna Station';
        ...
        id += 1;
        calendar.id = String(id);
        calendar.name = 'To Danapur Station';
        calendar.color = '#ffffff';
        ...
        id += 1;
        calendar.id = String(id);
        calendar.name = 'From Danapur Station';
        calendar.color = '#ffffff';
        ...
        id += 1;
        calendar.id = String(id);
        calendar.name = 'From Patna Station';
        calendar.color = '#ffffff';
