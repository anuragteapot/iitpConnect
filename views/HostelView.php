                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <h4>Block Details : <?php echo $block . "-"; echo $floor; if($room < 9) { echo '0'; } echo $room; ?></h4>
                                <hr>
                        ...
                        <div class="row">
                            ...
                            <h4 class="d-flex justify-content-between align-items-center mb-3">
                                <span class="text-muted">Overall Block Details</span>
                            </h4>
                            ...
                            <h4 class="mb-3">Block details</h4>
                            <hr>
                            <form>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="name_1" placeholder="Name.." value="" required="">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="roll_1" placeholder="Roll no.." value="" required="">
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="email_1" placeholder="Email.." value="" required="">
                                        <div class="invalid-feedback">
                                        Valid last name is required.
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="mobile_1" placeholder="Mobile.." value="" required="">
                                        <div class="invalid-feedback">
                                        Valid last name is required.
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="super_1" placeholder="Supervision / Faculty" value="" required="">
                                        <div class="invalid-feedback">
                                        Valid last name is required.
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3">
                                    <label for="username">Single Occupants</label>
                                    <div class="input-group">
                                        <input id="single_oc" type="checkbox" data-toggle="toggle" data-off="NO" data-on="YES" data-onstyle="warning" data-offstyle="info">
                                    </div>
                                    </div>
                                    <hr>
                                    <h5>Stock Status</h5>
                                    <div class="row">
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="beds" placeholder="No. of Beds">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="chairs" placeholder="No. of Chairs">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="table" placeholder="No. of Table" required>
                                            <div class="invalid-feedback">
                                            Zip code required.
                                            </div>
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="fan" placeholder="No. of Fan" required="">
                                            <div class="invalid-feedback">
                                            Zip code required.
                                            </div>
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <label for="Tubelight">Tubelight</label>
                                            <input type="text" class="form-control" id="tubelight" placeholder="No. of Tubelights" required="">
                                            <div class="invalid-feedback">
                                            Zip code required.
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="cc-name">Type of damage : </label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="cc-number">Room Status</label>
                                        <select id="block" class="selectpicker show-tick form-control" data-live-search="true">
