                        ...
                        <div class="row">
                            <div class="col-md-4 order-md-2 mb-4">
                                <h4 class="d-flex justify-content-between align-items-center mb-3">
                                    <h5>Overall Details Block : <?php echo $block; ?> </h5>
                                </h4>
                            ...
                            <div class="col-md-8 order-md-1">
                                ...
                                <form id="myForm" enctype="multipart/form-data" method="post" name="myForm">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="rc">Room Status</label>
                                            <select id="rc" name="rc" class="selectpicker show-tick form-control" data-live-search="true">
