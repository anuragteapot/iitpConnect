...
class Router
{
  ...
  public function execute()
  {
    ...
    Routes::setRoute('home', function () {
      AdminController::CreateView('Home');
    });

    Routes::setRoute('downloadStock', function () {
      AdminController::CreateView('DownloadStock');
    });

    Routes::setRoute('downloadOccupants', function () {
      AdminController::CreateView('DownloadOccupants');
    });

    Routes::setRoute('downloadStatus', function () {
      AdminController::CreateView('DownloadStatus');
    });

    Routes::setRoute('index.php', function () {
      if (!User::isLoggedIn(true)) {
        AdminController::CreateView('login');
      } else {
        AdminController::CreateView('Home');
      }
    });
    ...
    Routes::setRoute('message', function () {
      if (User::isLoggedIn(true)) {
        AdminController::CreateView('Message');
      }
    });

    Routes::setRoute('users', function () {
      if (User::isLoggedIn(true)) {
        AdminController::CreateView('UsersDetails');
      }
    });
  }
