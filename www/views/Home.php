...
<head>
	...
	<noscript>
		<link rel="stylesheet" href="<?php echo BASE_URL; ?>templates/css/noscript.css" /></noscript>
</head>
	...
	<div id="wrapper">
		...
		<nav id="menu">
			...
			<ul>
				...
				<?php else : ?>
				<li>
					<p style="cursor:pointer;" id="logoutuser">Logout</p>
				</li>
				<?php endif; ?>
			</ul>
		</nav>
			...
			<div class="inner">
				...
				<section class="tiles">
					<article class="style3">
						...
						<a href="<?php echo BASE_URL; ?>iitphostel">
		...
		<footer id="footer">
			<div class="inner">
				...
				<ul style="color:white;text-align:center;" class="copyright">
					...
					<li>Created by <a href="https://anu1601cs.github.io/my_web/">Anurag (@anu1601cs)</a>.</li>
				</ul>
			</div>
		</footer>
